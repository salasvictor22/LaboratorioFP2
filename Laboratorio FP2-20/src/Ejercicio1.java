...
public class Ejercicio1 {
    public static void main(String[] args) {  	
        ...
        while (jugarDeNuevo) {
        	...
        	ArrayList<Soldado> ejercito1 = crearEjercito1(espadachines, arqueros, caballeros, lanceros);
        	ArrayList<Soldado> ejercito2 = crearEjercito2(espadachines, arqueros, caballeros, lanceros);
        	...
        	System.out.println("\nBatalla entre el ejrcito1 vs el ejercito2, ganara el que tenga mas soldados en su ejercito");
            ...
            if (!respuesta.equals("si")) {
                ...
                caballeros.clear();
                lanceros.clear();
                ejercito1 = crearEjercito1(espadachines, arqueros, caballeros, lanceros);
                ejercito2 = crearEjercito2(espadachines, arqueros, caballeros, lanceros);
            }
        }
    }
    ...
    public static ArrayList<Soldado> crearEjercito1(ArrayList<Espadachin> espadachines, ArrayList<Arquero> arqueros, ArrayList<Caballero> caballeros, ArrayList<Lancero> lanceros) {
    ...
    public static ArrayList<Soldado> crearEjercito2(ArrayList<Espadachin> espadachines, ArrayList<Arquero> arqueros, ArrayList<Caballero> caballeros, ArrayList<Lancero> lanceros) {
        ArrayList<Soldado> ejercito = new ArrayList<>();
        int numSoldados = (int) (Math.random() * 10) + 1;
